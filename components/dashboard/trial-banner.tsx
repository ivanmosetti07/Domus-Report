        ...
        <CardContent className="p-6">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-start gap-3 flex-1">
              <div className={`flex items-center justify-center w-12 h-12 rounded-full flex-shrink-0 ${isUrgent ? 'bg-orange-100' : 'bg-blue-100'}`}>
                {isUrgent ? (
                  <AlertCircle className={`w-6 h-6 ${isUrgent ? 'text-orange-600' : 'text-blue-600'}`} />
                ) : (
            ...
            <Link href="/dashboard/subscription">
              <Button className={isUrgent ? 'bg-orange-600 hover:bg-orange-700' : 'bg-blue-600 hover:bg-blue-700'}>

...
export function FinalCta() {
  return (
    <section className="relative w-full py-24 sm:py-32 lg:py-40 bg-background overflow-hidden border-t border-white/5">
      {/* Dynamic Backgrounds */}
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-12 max-w-[1000px] mx-auto text-center space-y-12">
        <ScrollReveal className="space-y-6">
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-tight tracking-tight text-foreground">
            Il tuo <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-accent to-primary drop-shadow-[0_0_15px_rgba(var(--primary),0.3)] animate-gradient bg-[length:200%_auto]">Agente AI</span> lavora per te.
          </h2>
        ...
        <ScrollReveal animation="reveal-scale" delay={200} className="flex flex-col sm:flex-row gap-6 justify-center items-center">
        ...
        <ScrollReveal animation="reveal-fade" delay={400} className="flex flex-wrap items-center justify-center gap-8 pt-8">
          {[

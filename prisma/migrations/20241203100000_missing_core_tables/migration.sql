...
-- CreateIndex
CREATE UNIQUE INDEX "analytics_daily_agency_id_date_key" ON "analytics_daily"("agency_id", "date");
...
-- AddForeignKey
ALTER TABLE "agency_sessions" ADD CONSTRAINT "agency_sessions_agency_id_fkey" FOREIGN KEY ("agency_id") REFERENCES "agencies"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "lead_statuses" ADD CONSTRAINT "lead_statuses_lead_id_fkey" FOREIGN KEY ("lead_id") REFERENCES "leads"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "lead_statuses" ADD CONSTRAINT "lead_statuses_created_by_agency_id_fkey" FOREIGN KEY ("created_by_agency_id") REFERENCES "agencies"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "property_attachments" ADD CONSTRAINT "property_attachments_property_id_fkey" FOREIGN KEY ("property_id") REFERENCES "properties"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "analytics_daily" ADD CONSTRAINT "analytics_daily_agency_id_fkey" FOREIGN KEY ("agency_id") REFERENCES "agencies"("id") ON DELETE CASCADE ON UPDATE CASCADE;

  ...
  try {
    ...
    const pdf = await generateLeadPDF({
      ...
      property: {
        ...
        quartiere: lead.property.quartiere ?? null,
        locali: lead.property.locali ?? null,
        bagni: lead.property.bagni ?? null,
        spaziEsterni: lead.property.spaziEsterni ?? null,
        postoAuto: lead.property.postoAuto ?? null,
        riscaldamento: lead.property.riscaldamento ?? null,
        ariaCondizionata: lead.property.ariaCondizionata ?? null,
        classeEnergetica: lead.property.classeEnergetica ?? null,
        annoCostruzione: lead.property.annoCostruzione ?? null,
        statoOccupazione: lead.property.statoOccupazione ?? null,
      },
      valuation: {
